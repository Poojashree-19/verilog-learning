...
module instruction_memory(
    ...
    initial begin
        ...
        // -------------------------------------------------
        // Custom AVG Instruction Test
        // -------------------------------------------------

        memory[12] = 32'h01400513;   // ADDI x10,x0,20
        memory[13] = 32'h00A00593;   // ADDI x11,x0,10
        memory[14] = 32'hAAB5560B;   // AVG x12,x10,x11
...
always_comb begin
    ...
    case (ALUOp)
       ...
       // -------------------------------------------------
       // R-Type Instructions + Custom AVG
       // -------------------------------------------------
       2'b10: begin
       // -------------------------------
       // Custom AVG Instruction
...
always_comb begin
    ...
    case (alu_control)
        ...
        // -------------------------------------------------
        // AVG (Custom Instruction)
        // result = (operand_a + operand_b) / 2
        // -------------------------------------------------
        4'b1010:
...
module performance_counters(
    ...
    output logic [31:0] memory_count,
    output logic [31:0] avg_count
